...
function lan() {
    ...
    setTimeout(() => {
        ...
        if (html_dir)
            html_dir.style.direction = en ? "rtl" : "ltr";
        if (html_btn)
            html_btn.innerHTML = content.btn;
        if (html_name)
            html_name.innerHTML = content.name;
        // Helper function to update arrays of elements
        const updateElements = (elements, values) => {
        ...
        if (html_about_me)
            html_about_me.innerHTML = content.about_me;
        ...
        if (html_footer_text)
            html_footer_text.innerHTML = content.footer_text;
